...
<body>
   ...
   <div id="cart-page">
      <?php
      if (isset($pageConfig['cart_page']) && $pageConfig['cart_page'] != '' && file_exists('bp_config/includes/templates/cart_page_templates/' . $pageConfig['cart_page'])) {
         require 'bp_config/includes/templates/cart_page_templates/' . $pageConfig['cart_page'];
      }
      ?>
   </div>
   ...
   <script type="text/javascript">
      $(function() {
         ...
         cartPdtArrNew.forEach(function(d) {
            ...
            d.trlPrice = parseFloat(d.trlPrice);
            d.Qty = parseFloat(d.Qty);
            d.Trlship = parseFloat(d.Trlship);
