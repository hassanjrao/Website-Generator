...
<head>
    ...
    <?php require_once "./bp_config/css/style.php"; ?>
...
<body>
    ...
    <?php
    if (isset($pageConfig['footer_template']) && $pageConfig['footer_template']!='' && file_exists('bp_config/includes/templates/footer/' . $pageConfig['footer_template'] )) {
        require 'bp_config/includes/templates/footer/' . $pageConfig['footer_template'];
    }
    ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var bill_model = <?= $thisProduct['billingModel']; ?>
            //var sale_type = sessionStorage.getItem("data_sale_type");
            var multiPrice = '<?= $thisProduct['straightSaleMultiPrice']; ?>';
            var prod_id = <?= $thisProduct['id']; ?>;
    ...
    <script type="text/javascript">
        ...
        $("#product_cat_main").val('<?= $thisProduct['category']; ?>');
        // new condition for price
        var b_model = <?= $thisProduct['billingModel']; ?>;

        //QUANTITY INCREASE AND DECREASE
        $(function() {

            var b_model = <?= $thisProduct['billingModel']; ?>;
            var pdt_id = <?= $thisProduct['id']; ?>;
            ...
            $('#increase').on('click', function() {
                ...
                var billmodel = <?= $thisProduct['billingModel']; ?>;
        ...
        function AddtoCart() {
            ...
            var singleProduct = {};
            var bill_mod = <?= $thisProduct['billingModel']; ?>;
            ...
            <?php } ?>
            singleProduct.billModel = <?= $thisProduct['billingModel']; ?>;
    ...
    <script>
        var main_cat = $('.pdt-button').data("product-category");
        var product_id = $('.pdt-button').data("prod-id");
        var billing_model = $('.pdt-button').data("product-billmodel");

        $data_product = $('.pdt-button').data("product");
        $data_product_category = $('.pdt-button').data("product-category");
        $data_product_title = $('.pdt-button').data("product-title");
        $data_product_alias = $('.pdt-button').data("product-alias");
        $data_product_description = $('.pdt-button').data("product-description");
        if (billing_model == 1) {
            $data_product_price = $('.pdt-button').data("product-price");
        }
        if (billing_model == 2 || billing_model == 8) {
            $data_product_price = $('.pdt-button').data("product-trlshipping");
        }
        if (billing_model == 3) {
            $data_product_price_cont =
                +$('.pdt-button').data("product-cntntyprice") +
                +$('.pdt-button').data("product-cntntyshipping");
        ...
        $data_product_shipping = $('.pdt-button').data("product-shipping");
        $data_product_rbllprice = $('.pdt-button').data("product-rbllprice");
        $data_product_trlshipping = $('.pdt-button').data("product-trlshipping");
        $data_product_cntntyprice = $('.pdt-button').data("product-cntntyprice");
        $data_product_cntntyshipping = $('.pdt-button').data("product-cntntyshipping");
        $data_product_billing_model = $('.pdt-button').data("product-billmodel");
        $data_product_size_option = $('.pdt-button').data("product-size-option");
        $data_product_MultiPrice = $('.pdt-button').data("product-MultiPrice");
        $data_product_id = $('.pdt-button').data("product-id");
        $data_product_link = $('.pdt-button').data("product-image-link");
        $data_product_qty = $('.pdt-button').data("product-quantity");
