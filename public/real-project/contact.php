...
<body>
    ...
    <div id="contact-page">
        <?php
        if (isset($pageConfig['contact_page']) && $pageConfig['contact_page']!='' && file_exists('bp_config/includes/templates/contact_page_templates/contact_page' . $pageConfig['contact_page'] . '.php')) {
