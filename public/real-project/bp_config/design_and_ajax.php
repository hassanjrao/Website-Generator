<?php
    ...
    if($_POST['type']==4){
        ...
        if($model_id==1){
            $pdt_price = $selected_product['ssPrice'];
        }
        if($model_id==2){
            $pdt_price = $selected_product['trialShipping'];
        }
        if($model_id==3){
            $cont_price = $selected_product['continuityPrice'] + $selected_product['continuityShipping'];
    ...
    if($_POST['type']==5){
        $prod_id=$_POST['prod_id'];
        $selected_product = $products[$prod_id]['size_option'];
