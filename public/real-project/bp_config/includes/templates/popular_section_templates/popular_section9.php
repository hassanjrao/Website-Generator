    ...
    <div class="container" id="products">
      ...
      <div class="product-wrapper row">
            ...
            <?php 
                ...
                ?>
                <div  
                  class="product-section product-section9 col-lg-4 col-12" 
                  data-product="<?= $key;?>"
                    ...
                    <div class="product-details"> 
                      ...
                      <?php 
                        ...
                        if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                            <p class="prod_price9"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                        <?php }
                        if($product['billingModel']==3){ ?>
                            <p class="prod_price9"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                        <?php }
