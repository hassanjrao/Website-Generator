               ...
               <div class="swiper popular-slider1">
                  <div class="swiper-wrapper">
                     <?php
                        ...
                        uksort($products_rand1, function() { return rand() > rand(); });
                        $i = 0;
                        ...
                        ?>
                        <div  
                           class="product-section swiper-slide" 
                                    ...
                                    <div class="pdt-price-wrapper">
                                       <?php 
                                          ...
                                          if($product['billingModel']==3){ ?>
                                             <p class="prod_price13"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                                          <?php }
                  ...
                  <div class="ft-prev ft-button-prev1 ft-nav"><</div>
               ...
               <div class="swiper popular-slider2">
                  <div class="swiper-wrapper">
                     <?php
                        ...
                        uksort($products_rand2, function() { return rand() > rand(); });
                        $i = 0;
                  ...
                  <div class="ft-prev ft-button-prev2 ft-nav"><</div>
               ...
               <div class="swiper popular-slider3">
                  <div class="swiper-wrapper">
                     <?php
                        ...
                        uksort($products_rand3, function() { return rand() > rand(); });
                        $i = 0;
                  ...
                  <div class="ft-prev ft-button-prev3 ft-nav"><</div>
