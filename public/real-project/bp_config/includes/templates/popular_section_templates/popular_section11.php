               ...
               <div class="swiper popular-slider">
                  <div class="swiper-wrapper">
                     <?php 
                        ...
                        ?>
                        <div  
                          class="product-section product-section11 swiper-slide" 
                                  ...
                                  <div class="pdt-price-wrapper">
                                    <?php 
                                        ...
                                        if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                                          <p class="prod_price11"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                                        <?php }
                                        if($product['billingModel']==3){ ?>
                                          <p class="prod_price11"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                                        <?php }
