                   ...
                   foreach ($value as $k => $v){
                       ...
                       if($v == 'active' && $i <= $pageConfig['popularProducts']['popularProducts']){
                           ...
                           if($product['status']=='active')
                           {
                              ...
                              ?>
            <div  
                  class="product-section product-section5 col-lg-3 col-12" 
                  data-product="<?= $key;?>"
                        ...
                        <div class="pdt-price-wrapper">
                           <?php 
                              if($product['billingModel']==1 && $product['straightSaleMultiPrice']=='no'){ ?>
                                 <p class="prod_price5"><span>$<?= $product['ssPrice'] ?></span></p>
                              <?php }
                              ...
                              if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                                 <p class="prod_price5"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                              <?php }
                              if($product['billingModel']==3){ ?>
                                 <p class="prod_price5"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                              <?php }
                              if($product['billingModel']==4){ ?>
                                 <p class="prod_price5"><span>$<?= $product['trialShipping'] ?></span></p>
                              <?php }
