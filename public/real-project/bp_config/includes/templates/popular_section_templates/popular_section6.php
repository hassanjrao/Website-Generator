                             ...
                             if($v == 'active' && $i <= $pageConfig['popularProducts']['popularProducts']){
                                 ...
                                 if($product['status']=='active')
                                 {
                                    ...
                                    if($product['straightSaleMultiPrice']=='yes' && $product['billingModel']=='1')
                                     ...
                                     ?>
                  <div  
                        class="product-section product-section6 col-lg-3 col-12" 
                        data-product="<?= $key;?>"
                              ...
                              <div class="pdt-price-wrapper">
                                 <?php 
                                    if($product['billingModel']==1 && $product['straightSaleMultiPrice']=='no'){ ?>
                                       <p class="prod_price6"><span>$<?= $product['ssPrice'] ?></span></p>
                                    <?php }
                                    ...
                                    if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                                       <p class="prod_price6"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                                    <?php }
                                    if($product['billingModel']==3){ ?>
                                       <p class="prod_price6"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                                    <?php }
                                    if($product['billingModel']==4){ ?>
                                       <p class="prod_price6"><span>$<?= $product['trialShipping'] ?></span></p>
                                    <?php }
