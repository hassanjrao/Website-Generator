      ...
      <div class="container" id="products">
         <div class="pdtHeading pb-5">
            ...
            <div class="popular-navigation-wrapper d-flex flex-row justify-content-center">
               <div class="ft-button-prev ft-nav"><</div>
               ...
               <div class="swiper popular-slider">
                  <div class="swiper-wrapper">
                     ...
                     // To randomize the products on the home page
                        ...
                        ?>
                        <div  
                           class="product-section product-section10 swiper-slide" 
                                 ...
                                 <div class="pdt-price-wrapper">
                                    <?php 
                                       ...
                                       if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                                          <p class="prod_price10"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                                       <?php }
                                       if($product['billingModel']==3){ ?>
                                          <p class="prod_price10"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                                       <?php }
