...
<footer class="footer footer7 footer-background-color" id="footer">
   <div class="container">
    <div class="row">
      <div class="col-lg-3">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="mb-5 mb-md-0"> 
          ...
          <ul class="contact-widget">
            <li class="d-flex"> 
              <div class="info mb-3"><i class="fas fa-map-marker-alt fs-1 me-2"></i> <?= $generalConfig['address'] ?></div>
            </li>
            <li class="d-flex"> 
              <div class="info  mb-3"><i class="fas fa-phone-alt  fs-1 me-2"></i> <?= $generalConfig['phone_number'] ?></div>
            </li>
            <li class="d-flex">
              <div class="info"><i class="fas fa-envelope  fs-1 me-2"></i> <a href="mailto:<?= $generalConfig['email'] ?>"  style="word-break: break-all;"><?= $generalConfig['email'] ?></a></div>
            </li>
          </ul>
          <!--Contact--> 
        </div>
