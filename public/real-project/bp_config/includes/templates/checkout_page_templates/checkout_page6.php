                                ...
                                <table class="table  table-cart mb-5">
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="form-heading2">$<span id="shipping_subtotal" value='0.00'>0.00</span></td>
                                        </tr>
                                        <tr id="shipping-insurance-tr" style="display: none;">
                                            ...
                                            <td class="form-heading2">$<span id="shipping-insurance-price" value='0.00'><?= $pageConfig['shippingOption']['shippingOptionPrice']; ?></span></td>
                                        </tr>
                                        <tr>
