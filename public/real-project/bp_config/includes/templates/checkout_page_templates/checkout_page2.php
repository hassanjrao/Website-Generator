                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 left order-md-1 order-2">
                            ...
                            <div class="tab">
                                ...
                                <div class="field-wrapper address">
                                    ...
                                    <input type="text" class="form-control" name="shippingAddress1" id="shippingAddress1" placeholder="Street Address"
                                        value="">
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="field-wrapper city">
                                            ...
                                            <input type="text" class="form-control" name="shippingCity" id="shippingCity" placeholder="Town/City"
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="payment-form px-3 py-3 row m-0">
                                        <div class="col-12">
                                            <div class="field-wrapper card-num">
                                                ...
                                                <input type="tel" class="form-control" name="cc_no" id="cc_no" maxlength="16"
                        ...
                        <div class="col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 right order-md-2 order-1">
                            ...
                            <table class="table" id="total-cost">
                                ...
                                <tr id="shipping-insurance-tr" style="display: none;">
                                    ...
                                    <td>$<span id="shipping-insurance-price" value='0.00'><?= $pageConfig['shippingOption']['shippingOptionPrice']; ?></span></td>
                                </tr>
                                <tr>
...
<script>
    ...
    function formStep1Validation(){
        ...
        let userData = {firstName:firstName, lastName:lastName, phone:phone , email:email}; 
