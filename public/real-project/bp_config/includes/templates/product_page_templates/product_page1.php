                           ...
                           $(".qty-select").html(
                               ...
                               '<select class="select-qty" id="qty_dropdown">' +
                                    <?php foreach ($options as $option) { ?>
                                            '<option value="<?= $option['option_quantity']; ?>" data-price="<?= $option['option_price']; ?>"><?= $option['option_quantity']; ?></option>' +
                                    <?php } ?>
                               '</select>'
                           );
                       }
                          ...
                          <div class="tab-content">
                              <div class="tab-pane in active" id="desc">
                                 <p id="single_pdt_description">
                                    <script>document.write(sessionStorage.getItem('data_product_description'))</script>
                                 </p>
                              </div>
