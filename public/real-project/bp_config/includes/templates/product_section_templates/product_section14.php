         ...
         <div class="right">
            ...
            <div class="product-wrapper row m-0">
                  ...
                  <?php
                     ...
                     ?>
                     <div
                        class="product-section product-section14 col-lg-4 col-12 p-0"
                              ...
                              <div class="pdt-price-wrapper">
                                 <?php
                                    ...
                                    if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                                       <p class="prod_price14"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                                    <?php }
                                    if($product['billingModel']==3){ ?>
                                       <p class="prod_price14"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                                    <?php }
