      ...
      <div class="product-wrapper row">
            ...
            <?php
               ...
               if($product['status']=='active')
               {
                  ...
                  ?>
               <div
                  class="product-section col-lg-4 col-12"
                  ...
                  <div class="product-block">
                     ...
                     <?php
                        if($product['billingModel']==1 && $product['straightSaleMultiPrice']=='no'){ ?>
                           <p class="prod_price2 primary-text-color"><span>$<?= $product['ssPrice'] ?></span></p>
                        <?php }
                        if($product['billingModel']==1 && $product['straightSaleMultiPrice']=='yes'){
                            $prod_variant_count = count($product['shop_option']);
                          ?>
                           <p class="prod_price2 primary-text-color">
                               <span>
                        ...
                        if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                           <p class="prod_price2 primary-text-color"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                        <?php }
                        if($product['billingModel']==3){ ?>
                           <p class="prod_price2 primary-text-color"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?>  for shipping</span></p>
                        <?php }
                        if($product['billingModel']==4){ ?>
                           <p class="prod_price2 primary-text-color"><span>$<?= $product['trialShipping'] ?></span></p>
                        <?php }
