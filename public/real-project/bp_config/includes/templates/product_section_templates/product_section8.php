   ...
   <div class="container" id="products">
      ...
      <div class="product-wrapper row gx-0">
            ...
            <?php
               ...
               ?>
               <div
                  class="product-section product-section8 col-lg-3 col-12 px-2 mb-4"
                    ...
                    <?php } ?>
                     ...
                     <?php
                        ...
                        if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                           <p class="prod_price8 "><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                        <?php }
                        if($product['billingModel']==3){ ?>
                           <p class="prod_price8 "><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                        <?php }
