  ...
  <div class="container" id="products">
    <div class="product-wrapper row">
      ...
      <?php
          ...
          ?>
          <div
            class="product-section product-section7 col-lg-3 col-12"
                ...
                <span class="prod-price">
                  <?php
                    ...
                    if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                        <p class="prod_price12"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                    <?php }
                    if($product['billingModel']==3){ ?>
                        <p class="prod_price12"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                    <?php }
