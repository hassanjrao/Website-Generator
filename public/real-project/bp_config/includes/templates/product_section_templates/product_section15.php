   ...
   <div class="container" id="products">
      ...
      <div class="product-wrapper row gx-3">
            ...
            <?php
               ...
               ?>
               <div
                  class="product-section product-section15 col-xl-4 col-md-6 col-12"
                        ...
                        <div class="pdt-price-wrapper position-relative">
                           ...
                           <?php
                              ...
                              if($product['billingModel']==3){ ?>
                                 <p class="prod_price15"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                              <?php }
