   ...
   <h3 class="fw-bold pb-3"><?= $updateContent['shopTitle'] ?></h3>
      ...
      <div class="product-wrapper row">
            ...
            <?php
               ...
               ?>
               <div
                  class="product-section product-section1 col-lg-3 col-12"
                   ...
                   <h5 class="product-title product-name1"><?= $product['name'] ?></h5>
                     ...
                     <?php
                        ...
                        if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                           <p class="prod_price1"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                        <?php }
                        if($product['billingModel']==3){ ?>
                           <p class="prod_price1"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                        <?php }
