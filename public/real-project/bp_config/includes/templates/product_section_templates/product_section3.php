...
<h2><?= $updateContent['shopTitle'] ?></h3></h2>
      ...
      <div class="product-wrapper row">
            ...
            <?php
               ...
               ?>
               <div
                  class="product-section product-section3 col-lg-3 col-12"
...
<div class="price-cell">
                     <?php
                        ...
                        if($product['billingModel']==2 || $product['billingModel']==8){ ?>
                           <p class="prod_price3"><span>$<?= $product['trialPrice']; ?> + <?= $product['trialShipping']; ?> for shipping</span></p>
                        <?php }
                        if($product['billingModel']==3){ ?>
                           <p class="prod_price3"><span>$<?= $product['continuityPrice']; ?> + <?= $product['continuityShipping']; ?> for shipping</span></p>
                        <?php }
