<?php
   ...
   foreach ($products as $key => $value){
         ...
         if($v == 'active'){
            ...
            if($product['billingModel']==1 ){
               if($product['straightSaleMultiPrice']=='yes'){
                  ...
                  ?>
                  <div class="terms_cond" style="display:none;"><p><?= $product['name']; ?> - <?= $generalConfig['naming_convention']['1'] ?></p> <?php
                  echo $typeA_multiprice = $string.'</div>';
               }
               else{ ?>
                  <div class="terms_cond" style="display:none;"><p><?= $product['name']; ?> - <?= $generalConfig['naming_convention']['1'] ?></p>
                  <?php
            ...
            if($product['billingModel']==2 ){ ?>
               <div class="terms_cond" style="display:none;"><p><?= $product['name']; ?> - <?= $generalConfig['naming_convention']['2'] ?></p>
               <?php
            // For Trial
            echo $typeB = '
            ...
            if ($product['billingModel']==3){ ?>
               <div class="terms_cond" style="display:none;"><p><?= $product['name']; ?> - <?= $generalConfig['naming_convention']['3'] ?> <p/>
               <?php
            // For Continuity
            echo $typeC = '
      ...
      if($product['billingModel']==1 && $billing_module==1 && $product['id'] == $pid)  { ?>
            ...
            <?php }   if (($product['billingModel']==2  && $billing_module==2 && $product['id'] == $pid) || ($product['billingModel']==8  && $billing_module==2 && $product['id'] == $pid)){ ?>
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Trl"> <?= $product['name']; ?> - Trial</b><br/>
               <?= $typeB ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==3 && $billing_module==3 && $product['id'] == $pid){ ?>
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Cntnty"> <?= $product['name']; ?> - Continuity</b><br/>
               <?= $typeC ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==4 && $billing_module==1 && $product['id'] == $pid){ ?>
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Straight Sale"> <?= $product['name']; ?> - Straight Sale</b><br/>
               <?= $typeA ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==4 && $billing_module==2 && $product['id'] == $pid){ ?>
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Trl" > <?= $product['name']; ?> - Trial</b><br/>
               <?= $typeB ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==5 && $billing_module==1 && $product['id'] == $pid ){ ?>
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Straight Sale"> <?= $product['name']; ?> - Straight Sale</b><br/>
               <?= $typeA ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==5 && $billing_module==3 && $product['id'] == $pid ){ ?>
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Cntnty"> <?= $product['name']; ?> - Continuity</b><br/>
               <?= $typeC ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==6 && $billing_module==2 && $product['id'] == $pid){ ?>  
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Trl" > <?= $product['name']; ?> - Trial</b><br/>
               <?= $typeB ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==6 && $billing_module==3 && $product['id'] == $pid){ ?>  
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Cntnty"> <?= $product['name']; ?> - Continuity</b><br/>
               <?= $typeC ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==7 && $billing_module==1 && $product['id'] == $pid){ ?>  
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Straight Sale"> <?= $product['name']; ?> - Straight Sale</b><br/>
               <?= $typeA ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==7 && $billing_module==2 && $product['id'] == $pid){ ?>
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Trl"> <?= $product['name']; ?> - Trial</b><br/>
               <?= $typeB ?>
               <br/><br/>
            </div>
            <?php }   if ($product['billingModel']==7 && $billing_module==3 && $product['id'] == $pid){ ?>
            <div id="pid<?= $pid ?>">
               <b><input type="checkbox" class="prod_v_p" id="<?= $pid ?>" value="<?= $product['name']; ?>" p_name="<?= $product['name']; ?> Cntnty"> <?= $product['name']; ?> - Continuity</b><br/>
               <?= $typeC ?>
               <br/><br/>
