...
@php
    $addEdit = isset($slogan) ? 'Edit' : 'Add';
    $addUpdate = isset($slogan) ? 'Update' : 'Add';
@endphp
@section('page-title', $addEdit . ' slogan')
@section('content')
    ...
    <div class="content content-boxed">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default d-flex">
                <h3 class="block-title">{{ $addEdit }} slogan</h3>


                <a href="{{ route('slogans.index') }}" class="btn btn-primary push">All slogans</a>
                    ...
                    <div class="col-lg-12 ">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <input required type="text" value="{{ $slogan ? $slogan->title : null }}"
