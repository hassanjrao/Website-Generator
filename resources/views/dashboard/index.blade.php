...
@section('content')
    ...
    <div class="content">
        <div class="row row-deck">
            ...
            @can('view advertising companies')
            <div class="col-sm-6 col-xxl-3 col-md-3">
                <!-- New Customers -->
                <div class="block block-rounded d-flex flex-column">
                    <a href="{{ route('advertising-companies.index') }}">
                        <div
                            class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                            <dl class="mb-0">
                                <dt class="fs-3 fw-bold">{{ $advertisingCompanies }}</dt>
                                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">Advertising Companies</dd>
                            </dl>
                            <div class="item item-rounded-lg bg-body-light">
                        ...
                        <div class="bg-body-light rounded-bottom">
                            <a class="block-content block-content-full block-content-sm fs-sm fw-medium d-flex align-items-center justify-content-between"
                                ...
                                <span>View Advertising Companies</span>
                                <i class="fa fa-arrow-alt-circle-right ms-1 opacity-25 fs-base"></i>
                            </a>
                        </div>
                    </a>
